...
export class ConfigurableLoad implements ILoad{
    ...
    private _configurations      : LoadConfig[];
    private _configuration      !: LoadConfig;
    private _key                 : string;
    ...
    set configurations(configurations: LoadConfig[]) {
    ...
    get serialize() : ILoadStruct{
        ...
        this._configurations.forEach(function (this : ConfigurableLoad,actual,index) {
            data.configurations.push(actual.serialize);
        });
        return data;
    }
